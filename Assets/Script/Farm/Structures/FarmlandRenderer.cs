...
public class FarmlandRenderer : MonoBehaviour
{
    ...
    public void deepUpdateStructure(){
        ...
        if (statisticsSign == null)
        {
            ...
            statisticsSign.transform.localPosition = new Vector3(2.8f, 1, 4f);
        ...
        {
            farmLand = Instantiate((GameObject)GameManager.Instance.getResource("structures:farmland:farmland1"), transform);
        }
        ...
        if ((int)farmStructure.structurePropreties["quantity"] == 0){
            ...
            for (int x = 0; x < 5; x++){
                for (int y = 0; y < 5; y++){
                    ...
                    if ( 2.3f - (2.3f) * y + (2.3f / 4) * (x % 2) <= 2.3f && 2.3f - (2.3f) * y + (2.3f / 2) * (x % 2) >= -2.3f){
                        insertCrop(2.7f - (2.7f / 2) * x + Random.Range(-0.1f, 0.1f), 2.3f - (2.3f) * y + (2.3f / 2) * (x % 2) + Random.Range(-0.1f, 0.1f));
                    }
                }
            }
        }
            ...
            for (int x = 0; x < 5; x++){
                for (int y = 0; y < 7; y++){
                    ...
                    if ( 2.3f - (2.3f / 2) * y + (2.3f / 4) * (x % 2) <= 2.3f && 2.3f - (2.3f / 2) * y + (2.3f / 4) * (x % 2) >= -2.3f){
                        insertCrop(2.7f - (2.7f / 2) * x + Random.Range(-0.1f, 0.1f), 2.3f - (2.3f / 2) * y + (2.3f / 4) * (x % 2) + Random.Range(-0.1f, 0.1f));
                    }
                }
            }
        }
            ...
            for (int x = 0; x < 5; x++){
                for (int y = 0; y < 9; y++){
                    ...
                    if ( 2.3f - (2.3f / 3) * y + (2.3f / 6) * (x % 2) <= 2.3f && 2.3f - (2.3f / 3) * y + (2.3f / 6) * (x % 2) >= -2.3f){
                        insertCrop(2.7f - (2.7f / 2) * x + Random.Range(-0.1f, 0.1f), 2.3f - (2.3f / 3) * y + (2.3f / 6) * (x % 2) + Random.Range(-0.1f, 0.1f));
                    }
                }
            }
        }
    ...
    private void insertCrop(float x, float y){
        ...
        Instantiate((GameObject)GameManager.Instance.getResource(
            "structures:farmland:" + ((string)farmStructure.structurePropreties["resource"]).Split(":")[1]), empty.transform);
    ...
    public void updateStructure(){
        ...
        if (farmStructure.structurePropreties["resource"] != null && (int)(float)farmStructure.structurePropreties["age"] != 0)
        {
            ...
            node.transform.GetChild(0).GetChild(
                ...
                /
                FarmBase.growthTimes[(string)farmStructure.structurePropreties["resource"] +
